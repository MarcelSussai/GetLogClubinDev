...
const txt_p_02    = `Edite e gerencie um cardápio digital personalizável para ser exibido aos seus clientes. Ondem terão comodidade e facilidade para fazer seus pedidos de seus produtos! Tenha um pedaço do seu restaurante na internet!`
const txt_h3_03   = `E você entregador, ganhe mais entregando com a <span className="get"> Get</span><span className="log">Log</span><span className="club"> CLUB</span>!, se cadastre!`
